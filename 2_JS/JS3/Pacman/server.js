/* ============================================================
   GUSACAT — server.js
   Servidor estático simple con Node.js (sin dependencias).
...
const server = http.createServer((req, res) => {
  ...
  if (urlPath === '/') urlPath = '/index.html';  // raiz → index

  /* Buscar primero en /public, si no existe buscar en /assets */
  ...
  /* Seguridad: bloquear acceso fuera de las carpetas permitidas */
...
server.listen(PORT, () => {
  console.log(`\nBreaking bad pacman corriendo en http://localhost:${PORT}\n`);
});